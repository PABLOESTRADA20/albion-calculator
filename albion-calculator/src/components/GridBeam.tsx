...
const MONO_DARK: GridBeamPaletteLayers = {
  h: [
    { color: [103, 232, 249], op: 0.2 },
    { color: [125, 211, 252], op: 0.14 },
    { color: [255, 216, 138], op: 0.18 },
    { color: [56, 189, 248], op: 0.13 },
    { color: [165, 243, 252], op: 0.19 },
    { color: [94, 234, 212], op: 0.13 },
  ],
  v: [
    { color: [94, 234, 212], op: 0.16 },
    { color: [125, 211, 252], op: 0.13 },
    { color: [255, 216, 138], op: 0.17 },
    { color: [103, 232, 249], op: 0.15 },
    { color: [147, 197, 253], op: 0.17 },
    { color: [56, 189, 248], op: 0.12 },
  ],
};
